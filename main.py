...
from create_data import create_dataset, train_test_split, save_to_file, get_existing_data
...
def shuffle_data_for_cross_validation(train_data_loader, test_data_loader, train_spectrum_path, train_labels_path,
    ...
    existing_data = existing_data.reshape((amount_of_data, -1))
...
def main(train_spectrum_path=r"dataset/train_spectrum.npy", test_spectrum_path=r"dataset/test_spectrum.npy",
         ...
         batch_size=1, learning_rate=0.01, num_epochs=20, kernel_size=(1, 2), padding=(0, 0), dropout=True,
         ...
         fc2_amount_output_nodes=500, fc3_amount_output_node=100, stretch_data=False, knn=False,
         cross_validation_iterations=1, n_components=2, k="auto"):
    ...
    if create_dataset_now:
        ...
        create_dataset(data_files=valid_files, fruits=fruits, size_of_dataset=size_of_dataset,
                       ...
                       sample_type=sample_type, n_components=n_components)
    ...
    if train_now:
        ...
        if knn:
            ...
            for i in range(cross_validation_iterations):
                ...
                shuffle_data_for_cross_validation(train_data_loader=train_data_loader,
            ...
            print("Test accuracies standard deviation: {}".format(accuracies_std))
            plot_data.plot_box_plot(test_accuracies=cross_validation_accuracies)
            ...
            for i in range(cross_validation_iterations):
                ...
                model = CNN(amount_of_labels=len(fruit_label_enum), batch_normalization=batch_normalization,
                            ...
                            fc3_amount_output_node=fc3_amount_output_node, n_components=n_components)
            ...
            if show_statistics:
                ...
                plot_data.plot_classification_report(true_labels=cross_validation_true_labels,
                                                     predictions=cross_validation_predictions_of_last_epoch,
                                                     show_plot=True)
                ...
                losses, accuracies_train, accuracies_test, true_labels, predictions_of_last_epoch = statistics
                plot_data.plot_train_statistics1(losses=losses, train_accuracy=accuracies_train,
                                                 test_accuracy=accuracies_test, show_plot=True)
    ...
    if predict_now:
        ...
        # Get existing data
        existing_data, _ = get_existing_data(fruits=fruits, data_files=valid_files,
                                             sample_time=sample_time, sample_location=sample_location,
                                             data_width=data_width, sample_type=sample_type)
        ...
        confidence, prediction = predict(model=model, data_file=file_to_predict, pca=pca, transform=transform,
...
if __name__ == '__main__':
    ...
    main(create_dataset_now=True, num_epochs=100, kernel_size=(1, 2), padding=(0, 0),
         ...
         stretch_data=False, sample_location="anal", sample_time="after 5", fruits=fruits,
         data_width=2100,
         num_channels_layer1=30, num_channels_layer2=6, fc1_amount_output_nodes=100,
         fc2_amount_output_nodes=500,
         fc3_amount_output_node=100, tolerance=100, number_of_samples_to_alter=250, knn=True, k="auto",
         sample_type="pos",
         cross_validation_iterations=30, n_components=3)
